...
tweetFreq = 60 # how many minutes between tweets
subtweetChance = 10 # percent chance that the bot subtweets
topWords = 5 # number of top words to potentially choose from for our seed phrase
tweetCount = 200 # max number of tweets to pull from timeline, up to 200
